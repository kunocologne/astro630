...
export const qualityAutomation = {
  accessibility: {
    ...
    generateTests: (component: string) => {
      return `
  ...
  responsive: {
    generateBreakpoints: (_component: string) => {
      return {
        mobile: '320px - 768px',
        tablet: '768px - 1024px',
        desktop: '1024px+',
  ...
  performance: {
    checkLighthouse: (_component: string) => {
      return {
        performance: 90,
        accessibility: 95,
        bestPractices: 90,
    ...
    optimizeAnimations: (_component: string) => {
      return {
...
const componentDatabaseExport = {
  componentDatabase,
  qualityAutomation,
  errorHandling,
}

export default componentDatabaseExport
