...
export const exampleProducts = [
  {
    ...
    price: 299,
    description:
      'High-quality wireless headphones with noise cancellation and premium sound quality. Perfect for professionals and audiophiles.',
    images: [
      {
  ...
  },
  {
    ...
    price: 89,
    description:
      'Ergonomic aluminum laptop stand designed for productivity. Adjustable height and angle for optimal comfort.',
    images: [
      {
  ...
  },
  {
    ...
    price: 199,
    description:
      'Advanced fitness tracking with heart rate monitoring, GPS, and 7-day battery life. Waterproof design for all activities.',
    images: [
      {
  ...
  },
  {
    ...
    price: 149,
    description:
      'Professional-grade coffee maker with precision temperature control and built-in grinder. Perfect for coffee enthusiasts.',
    images: [
      {
  ...
  },
  {
    ...
    price: 399,
    description:
      'High-quality ergonomic office chair with lumbar support, adjustable height, and breathable mesh back.',
    images: [
      {
