    ...
    <ScrollReveal direction="up" delay={index * 0.1}>
      <AnimatedCard index={index} isStaggered={isStaggered} className="h-full w-full">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-white/50 backdrop-blur-sm dark:bg-black/20">
            {image ? (
          ...
          <div className="mt-4 space-y-2">
            <h3 className="line-clamp-2 text-base font-semibold tracking-tight transition-colors group-hover:text-foreground/70">
              {title}
            </h3>
