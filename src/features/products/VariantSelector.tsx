            ...
            {options?.map((option) => {
              ...
              return (
                <Button
                  ...
                  className={clsx(
                    'relative h-12 rounded-lg border-2 px-4 py-2 transition-all duration-200 focus:ring-2 focus:ring-primary/50 focus:ring-offset-2',
                    {
                      // Active state - selected option
                      'border-primary bg-primary/5 text-primary shadow-sm':
                        isActive && isAvailableForSale,
                      // Available but not selected
                      'hover:bg-primary/2 border-border text-foreground hover:border-primary/50':
                        !isActive && isAvailableForSale,
                      // Out of stock
